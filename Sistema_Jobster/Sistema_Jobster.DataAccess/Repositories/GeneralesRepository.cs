...
namespace Sistema_Jobster.DataAccess.Repositories
{
    public class GeneralesRepository
    {
        public IEnumerable<tbEstadosCiviles> ListEstadosCiviles()
        {
            ...
            var result = db.Query<tbEstadosCiviles>(ScriptDataBase.EstadosCiviles_Listar, commandType: System.Data.CommandType.StoredProcedure);
            return result;
        ...
        {
            using var db = new SqlConnection(Sistema_JobsterContext.ConnectionString);
            var result = db.Query<tbDepartamentos>(ScriptDataBase.Departamentos_Listar, commandType: System.Data.CommandType.StoredProcedure);
            return result;
        ...
        {
            using var db = new SqlConnection(Sistema_JobsterContext.ConnectionString);
            var result = db.Query<tbMunicipios>(ScriptDataBase.Municipios_Listar, commandType: System.Data.CommandType.StoredProcedure);
            return result;
